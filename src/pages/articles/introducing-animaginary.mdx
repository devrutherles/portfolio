...
export const meta = {
  author: 'Adam Wathan',
  date: '2022-09-02',
  title: 'Empresa: InnovateTech Solutions',
  description:
    'Função: Engenheiro de Software Full Stack Pleno Descrição: Colaboração no desenvolvimento de um aplicativo de gerenciamento de projetos, trabalhando em estreita colaboração com equipes de design e produto para implementar recursos avançados de usabilidade. Desenvolvimento de APIs, integrações de sistemas e otimização de desempenho.',
}

export default (props) => <ArticleLayout meta={meta} {...props} />

Função: Engenheiro de Software Full Stack Pleno
Descrição: Colaboração no desenvolvimento de um aplicativo de gerenciamento de projetos, trabalhando em estreita colaboração com equipes de design e produto para implementar recursos avançados de usabilidade. Desenvolvimento de API's, integrações de sistemas e otimização de desempenho.
