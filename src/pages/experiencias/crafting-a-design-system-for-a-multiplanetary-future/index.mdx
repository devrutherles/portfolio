...
export const meta = {
  author: 'Adam Wathan',
  date: '2021-03-04',
  title: 'Empresa: SoftCom Consultoria e desenvolvimento',
  description:
    'Função: Desenvolvedor Full Stack Pleno Descrição: Desenvolvimento de aplicativos web e sistemas internos, liderando a equipe de desenvolvimento e implementando soluções escaláveis para atender às necessidades do negócio. Responsável pela arquitetura, desenvolvimento e manutenção de plataformas de e-commerce e ferramentas de análise de dados.',
}

export default (props) => <ArticleLayout meta={meta} {...props} />

Função: Desenvolvedor Full Stack Pleno
Descrição: Desenvolvimento de aplicativos web e sistemas internos, liderando a equipe de desenvolvimento e implementando soluções escaláveis para atender às necessidades do negócio. Responsável pela arquitetura, desenvolvimento e manutenção de plataformas de e-commerce e ferramentas de análise de dados.
