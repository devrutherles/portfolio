...
export const meta = {
  author: 'Adam Wathan',
  date: '2023-06-14',
  title: 'Empresa: CodeTrue Sistemas e soluções',
  description:
    'Função: Desenvolvedor Full Stack Pleno Descrição: Liderança técnica no desenvolvimento de uma plataforma de e-learning, desde a concepção até a entrega. Desenvolvimento de recursos interativos, integrações de mídia social e implementação de sistemas de pagamento seguros. Colaboração com equipes multidisciplinares para garantir a qualidade e a entrega no prazo.',
}

export default (props) => <ArticleLayout meta={meta} {...props} />

Função: Desenvolvedor Full Stack Pleno
Descrição: Liderança técnica no desenvolvimento de uma plataforma de e-learning, desde a concepção até a entrega. Desenvolvimento de recursos interativos, integrações de mídia social e implementação de sistemas de pagamento seguros. Colaboração com equipes multidisciplinares para garantir a qualidade e a entrega no prazo.
